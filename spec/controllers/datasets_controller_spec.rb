...
describe DatasetsController do
  ...
  let(:valid_attributes) { { "data_file" => "MyString" } }
  ...
  describe "GET index" do
    it "assigns all datasets as @datasets", pending: true do
  ...
  describe "GET show" do
    it "assigns the requested dataset as @dataset", pending: true do
      dataset = Dataset.create! valid_attributes
  ...
  describe "GET new" do
    it "assigns a new dataset as @dataset" , pending: true do
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Dataset", pending: true do
        expect {
          post :create, {:dataset => valid_attributes}, valid_session
        }.to change(Dataset, :count).by(1)
      end

      it "assigns a newly created dataset as @dataset", pending: true do
        post :create, {:dataset => valid_attributes}, valid_session
        assigns(:dataset).should be_a(Dataset)
        assigns(:dataset).should be_persisted
      end

      it "redirects to the created dataset", pending: true do
        post :create, {:dataset => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved dataset as @dataset", pending: true do
        # Trigger the behavior that occurs when invalid params are submitted
        Dataset.any_instance.stub(:save).and_return(false)
        post :create, {:dataset => { "data_file" => "invalid value" }}, valid_session
        assigns(:dataset).should be_a_new(Dataset)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested dataset", pending: true do
        dataset = Dataset.create! valid_attributes
        ...
        Dataset.any_instance.should_receive(:update).with({ "data_file" => "MyString" })
        put :update, {:id => dataset.to_param, :dataset => { "data_file" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the dataset", pending: true do
        dataset = Dataset.create! valid_attributes
        put :update, {:id => dataset.to_param, :dataset => valid_attributes}, valid_session
    ...
    describe "with invalid params", pending: true do
      it "assigns the dataset as @dataset" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Dataset.any_instance.stub(:save).and_return(false)
        put :update, {:id => dataset.to_param, :dataset => { "data_file" => "invalid value" }}, valid_session
        assigns(:dataset).should eq(dataset)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested dataset", pending: true do
      dataset = Dataset.create! valid_attributes
      expect {
    ...
    it "redirects to the datasets list", pending: true do
      dataset = Dataset.create! valid_attributes
      delete :destroy, {:id => dataset.to_param}, valid_session
